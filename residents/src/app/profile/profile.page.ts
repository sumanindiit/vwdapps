...
export class ProfilePage implements OnInit {
  ...
  allCommunities: any = JSON.parse(localStorage.getItem('vwd_communities'));
  ...
  ngOnInit() {
    ...
    this.MycommunityValue = this.userData?.community.toString();
    this.updateProfileForm = this.formBuilder.group({
      ...
      community: [this.MycommunityValue, [Validators.required]],
      buildingNo: [this.userData?.buildingNo, [Validators.required, Validators.minLength(3)]],
      apartmentNo: [this.userData?.apartmentNo, [Validators.required, Validators.minLength(2)]]
    });
