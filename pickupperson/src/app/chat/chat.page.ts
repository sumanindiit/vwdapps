...
export class ChatPage implements OnInit {
  ...
  getResidentMessages()
  {
    this.api.post('getResidentMessages', {userId: this.userId , fromId: this.fromId },'')
      .subscribe(
        (result) => {
  ...
  onSubmit() {
    ...
    if (!this.messageForm.valid) {
      ...
      let notificationDict ={
        userId: this.userId,
        receiverId: this.fromId,
        title:'VWD Pick Up',
        body: 'You have new message from '+ this.userData.name
      };

      this.api.post('sendPickUpNotificationSingleUser', notificationDict,'')
